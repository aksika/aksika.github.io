...
<div style="display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 80vh; padding: 2rem 1rem;">
  <div style="position: relative; max-width: 1024px; width: 100%;">
    ...
    <!-- abTARS logo top-left -->
    <a href="/abtars/" style="position: absolute; top: 1%; left: 0%; width: 35%; height: 15%; display: block; z-index: 10;" title="abTARS — Bridge"></a>
    <!-- abmind logo top-right -->
    <a href="/abmind/" style="position: absolute; top: 0%; right: 0%; width: 38%; height: 18%; display: block; z-index: 10;" title="abmind — Memory"></a>
    ...
    <!-- BUILD AUTONOMOUS AGENTS box -->
    <a href="/abtars/" style="position: absolute; bottom: 15%; left: 3%; width: 28%; height: 9%; display: block; z-index: 10;" title="Build Autonomous Agents"></a>
  </div>
</div>
